...
ttt <- 2
k_index <- get_particle_indices_by_k(uni_particles, ttt)
...
samples_to_get <- 3000
est_fearnhead <- get_posterior_parameters_normal(k_particles,k_w, ttt, samples_to_get, xi, kappa, a, b, y)
...
fit <- NMixMCMC(
  y0 = y,
  prior = prior,
  nMCMC = c(burn = 10000, keep = 5000, thin = 5, info=500)
)

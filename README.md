...
## Prerequisites
- R with packages used across the scripts: `evd`, `truncnorm`, `MCMCpack`, `ggplot2`, `dplyr`, `tidyr`, `patchwork`, `tictoc`, `kde1d`, `gtools`, `cowplot`, `here`, `vistime`, and related dependencies. `dir_manager.r` contains a small install helper.
